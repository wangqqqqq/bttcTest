...
describe('bsc erc721 test', function() {
    ...
    describe('#no mintable token in mainChain', function() {
        ...
        it('burn', async function() {
            ...
            // burn
            tokenId = 86643;// Each test requires manual modification
            ...
            // balance after burn
            await wait(30)
            let userBalanceAfterBurnSide = await bscClient.balanceOfERC721(userAddr, erc721SideToken, {parent:false})
    ...
    describe('#mint', function() {
        ...
        it('burn', async function() {
            ...
            // burn
            tokenId = 28296;// Each test requires manual modification
