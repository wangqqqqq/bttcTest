    ...
    describe('#no mintable token in mainChain', function() {
        it('deposit', async function () {
            ...
            if (userBalanceBeforeMain < depositAmount) {
                ...
                bscClientContractOwner.mintERC20Token(erc20MainToken, mintAmount, {from: contractOwnerETHBSC.address, parent: true})
                do {
                    await wait(20)
            ...
            const predicateBalanceAfterMain = await bscClient.balanceOfERC20(
                erc20PredicateMain, erc20MainToken, {parent: true})
        ...
        it('burn', async function () {
            ...
            // burn
            const tx = await bscClient.burnERC20({
                childToken: erc20SideToken,
                withdrawTo: true,
    ...
    describe('#mintable token in mainChain', function () {
        it('deposit', async function() {
            ...
            if (userBalanceBeforeMain < depositAmount) {
                let ownerBalanceAfter
                const mintAmount = 1e20
                bscClientContractOwner.mintERC20TokenTo(merc20MainToken,userAddr,mintAmount,{from:contractOwnerETHBSC.address, parent:true})
                do{
                    await wait(20)
