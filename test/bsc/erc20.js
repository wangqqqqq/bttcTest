    ...
    describe('#no mint', function() {
        it('deposit & burn', async function() {
            ...
            if (allowance < depositAmount) {
                const result = await bscClient.approveMaxERC20ForDeposit(erc20MainToken, approveAmount, {from:userAddr})
            ...
            // burn
            bscClient = getBscClient(userPk,userAddr)
            const tx = await bscClient.burnERC20({ childToken: erc20SideToken, amount:depositAmount}, {
                from: userAddr,
